...
DATABASE_URL =''
```
3. Run `cd frontend/dashboard && mkdir dist && cd dist && wget https://github.com/kevinbencs/url_shorter/releases/download/build-20260209-234131/dashboard-dist.zip && unzip dashboard-dist.zip && cd `
